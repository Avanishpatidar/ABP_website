...
export interface Skill { name:string; logoUrl:string; color:string }
export const skillsData: Record<string, Skill[]> = {
  ...
  "Backend": [
    ...
    {
      "name": "Payload CMS",
      "logoUrl": "https://cdn.simpleicons.org/payloadcms",
      "color": "#000000"
    }
  ],
  "Agentic Stack": [
    {
      "name": "LangGraph",
      "logoUrl": "https://langchain-langchain.vercel.app/favicon.ico",
      "color": "#1C3C3C"
    },
    {
      "name": "CrewAI",
    ...
    {
      "name": "Pinecone",
      "logoUrl": "https://cdn.simpleicons.org/pinecone",
      "color": "#000000"
    },
    {
      "name": "ChromaDB",
      "logoUrl": "https://docs.trychroma.com/img/chroma.svg",
      "color": "#F37859"
    },
    {
      "name": "LangSmith",
  ...
  "DevOps & Cloud": [
    ...
    {
      "name": "Nginx",
      "logoUrl": "https://cdn.simpleicons.org/nginx",
      "color": "#009639"
    },
    {
      "name": "Ubuntu",
    ...
    {
      "name": "Render",
      "logoUrl": "https://cdn.simpleicons.org/render",
      "color": "#46E3B7"
    },
    {
      "name": "Railway",
